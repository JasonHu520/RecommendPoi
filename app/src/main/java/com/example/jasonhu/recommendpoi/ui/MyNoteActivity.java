...
import com.example.jasonhu.recommendpoi.adpter.MyNoteListAdapter;
import com.example.jasonhu.recommendpoi.bean.Note;
import com.example.jasonhu.recommendpoi.view.SpacesItemDecoration;
...
public class MyNoteActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        rv_list_main.setLoadingListener(new MyNoteActivity.MyLoadingListener());
        mNoteListAdapter.setOnItemClickListener(new MyNoteListAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, Note note) {
                ...
                Intent intent = new Intent(MyNoteActivity.this, NoteActivity.class);
