...
public class BottomControlPanel extends RelativeLayout implements View.OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_contacts:
			index = Constant.BTN_FLAG_RECOMMEND;
			mContactsBtn.setChecked(Constant.BTN_FLAG_RECOMMEND);
			break;
		case R.id.btn_news:
			index = Constant.BTN_FLAG_Me;
			mNewsBtn.setChecked(Constant.BTN_FLAG_Me);
			break;
	...
	public void BtnChecked(String tag){
	    switch (tag)
        {
            case Constant.FRAGMENT_FLAG_MESSAGE:
                if(mMsgBtn != null){
                    mMsgBtn.setChecked(Constant.BTN_FLAG_MESSAGE);
                }
                break;
            case Constant.FRAGMENT_FLAG_RECOMMEND:
              if(mContactsBtn!=null){
                  mContactsBtn.setChecked(Constant.BTN_FLAG_RECOMMEND);
              }
                break;
            case Constant.FRAGMENT_FLAG_Me:
              if(mNewsBtn!=null){
                ...
                break;
            case Constant.FRAGMENT_FLAG_SETTING:
                if(mSettingBtn!=null){
                    mSettingBtn.setChecked(Constant.BTN_FLAG_SETTING);
                }
                break;
